...
export default function CouponCard({ discount, code }: CouponCardProps) {
    return (
        <div className="relative w-[340px] h-[142px] flex-shrink-0 cursor-pointer group hover:scale-105 transition-all duration-300">
            {/* SVG Background */}
            ...
            <div className="relative z-10 w-full h-full flex">
                {/* Left Part */}
                <div className="w-[34%] flex flex-col items-center justify-center p-4 border-r-2 border-dashed border-white/20 my-6">
